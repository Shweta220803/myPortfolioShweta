...
const ContactPage = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 px-4 sm:px-10 pt-4 h-screen">
        {/* Left Column */}
        <div className="p-4 flex flex-col justify-center">
          <svg
            className="w-full h-auto max-w-lg" // Responsive SVG
            viewBox="0 0 900 600"
            fill="none"
        ...
        {/* Right Column */}
        <div className="p-4 flex flex-col justify-center w-full md:w-1/2">
          <form
            className="flex flex-col mx-auto max-w-md"
            onSubmit={handleSubmit}
          >
            <div className="relative mb-4">
              <FaCircleUser className="absolute left-3 top-2 text-white" />
              <input
                type="text"
                name="username"
                className="p-1 pl-10 border border-gray-300 rounded w-full bg-gray-800 text-white"
            ...
            <div className="relative mb-4">
              <FaRegEnvelope className="absolute left-3 top-2 text-white" />
              <input
                type="text"
                name="email"
                className="p-1 pl-10 border border-gray-300 rounded w-full bg-gray-800 text-white"
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-blue-800 text-white w-full max-w-xs p-2 text-center rounded hover:bg-blue-600 transition duration-300"
              >
                Submit
              </button>
            </div>
